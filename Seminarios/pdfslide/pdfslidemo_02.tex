% pdfslidemo.tex,v 1.1.2.1 2002/11/14 21:18:19 hansfn Exp
%  
...
\title{O Pacote \code{texpower} \\{\normalfont \texttt{pdfslide} Demo}}
\author{Salviano A. Leão \\\code{mailto:Stephan.Lehmke@cs.uni-dortmund.de}}
\maketitle
