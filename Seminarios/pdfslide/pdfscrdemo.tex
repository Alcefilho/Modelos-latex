% pdfscrdemo.tex,v 1.1.2.1 2002/11/14 21:18:19 hansfn Exp
%  
...
\emblema{unihaken-color}
\urlid{ls1-www.cs.uni-dortmund.de/~lehmke/texpower/}

%-----------------------------------------------------------------------------------------------------------------
% The texpower package is loaded. 
% We give the display option so dynamic features are enabled.
% We use texpower's slifonts option for better readability.
%
